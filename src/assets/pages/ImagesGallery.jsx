...
const WeddingImages = () => {
  ...
  return (
    <div className="font-montserrat">
      {/* Hero Section */}
      <section
        style={{ backgroundImage: `url(${weddingimage6})` }}
        className="hero min-h-screen bg-cover bg-center bg-no-repeat flex items-center justify-center text-center text-white px-4"
      >

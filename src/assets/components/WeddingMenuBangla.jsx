...
const WeddingMenuBangla = () => {
  ...
  const menuData = [
    ...
    // },
    {
      ...
      items: [
        ...
        { name: "আলু ভাজা", description: "" },
        { name: "ফ্রায়েড রাইস ", description: "" },
        { name: "চানা পনির", description: "" },
      ],
    },
    {
      id: "main-course",
    ...
    },
    {
      id: "mint",
      title: "🌿 মুখশুদ্ধি",
      items: [{ name: "পান মসলা", description: "" }],
    },
  ];
        ...
        if (element) {
          ...
          if (openCategory === categoryId) {
            window.gsap.to(element, {
              ...
              ease: "power2.out",
              onComplete: () =>
                window.gsap.set(element, { clearProps: "height" }), // Clear height after animation
            });
          } else {
  ...
  return (
    ...
    <>
      <link
        href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Lora:wght@400;700&family=Great+Vibes&family=Noto+Sans+Bengali:wght@400;700&display=swap"
        rel="stylesheet"
      />
      <div
        className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-100 text-bengoli"
        style={{
      ...
      >
        ...
        <div className="w-full max-w-2xl bg-white bg-opacity-95 p-4 rounded-3xl shadow-2xl mb-8 text-center border-b-4 border-rose-200">
          <h1 className="text-3xl md:text-6xl font-bold mb-4 font-great-vibes leading-tight text-rose-600 text-bengoli">
            {" "}
        ...
        <div className="w-full max-w-2xl bg-white bg-opacity-95 p-4 rounded-3xl shadow-2xl mb-8 text-center border-b-4 border-rose-200 text-bengoli">
          <h1 className="text-3xl md:text-6xl font-bold text-gray-800 mb-4 font-great-vibes leading-tight text-rose-600">
            আজকের <br /> আপ্যায়নের মেনু
          </h1>
          <p className="text-xl text-gray-700 font-lora italic">
            বিশেষ দিনে সুস্বাদু স্মৃতির এক অনন্য আয়োজন
          </p>
        </div>
        ...
        <div className="w-full max-w-2xl text-bengoli">
          {menuData.map((category) => (
            <div
              key={category.id}
              className="bg-white bg-opacity-98 rounded-2xl shadow-xl overflow-hidden mb-6 border border-gray-100"
            >
              ...
              <div
                ...
                className={`overflow-hidden ${
                  openCategory !== category.id ? "h-0 opacity-0" : ""
                }`}
              >
                <ul className="p-6 bg-white rounded-b-2xl">
                  {category.items.map((item, index) => (
                    <li
                      key={index}
                      className="mb-4 last:mb-0 pb-4 border-b border-gray-200 last:border-b-0"
                    >
                      <h3 className="font-lora font-bold text-gray-900 text-xl mb-1">
                        {item.name}
                      </h3>
        ...
        <div className="w-full max-w-2xl bg-white bg-opacity-95 p-4 rounded-3xl shadow-2xl mb-8 text-center border-b-4 border-rose-200 text-bengoli">
          <div className="mb-4">
            ...
            <Link to={"/"} className="text-xl text-gray-700 font-lora italic">
              🌐 ওয়েবসাইট ভিজিট করুন
            </Link>
          </div>
          {/* <div className="flex justify-between border-b">
            ...
            <div>
              ...
              <p className="text-xl text-gray-700 font-lora italic">
                মা মনসা ফ্লাওয়ার ডেকোরেশন
              </p>
            </div>
          </div> */}
          <div className="flex justify-center">
            <Link
              to="/wedding-spin-wheel"
              className="inline-block bg-pink-700 text-white w-36 py-2 mt-4 rounded-full shadow-lg animate-bounce"
            >
              🎮 Play a Game
            </Link>
  ...
  🎮 Rice Ceremony Quiz
        ...
        <footer
          className="text-center text-white text-sm mt-auto mb-4"

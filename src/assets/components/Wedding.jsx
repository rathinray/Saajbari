...
const Wedding = () => {
  ...
  const subheadline =
    "We specialize in creating stunning, budget-friendly wedding decorations that will make your special day unforgettable. From floral arrangements to lighting, we offer a wide range of services to suit your style and budget.";
      ...
      <section className="py-20 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div
              ref={underlineRef}
              className="w-0 h-1 bg-primary mx-auto mb-6"
            ></div>
            <h3 className="max-w-2xl mx-auto text-lg text-gray-600">
              We turn your vision into a beautiful reality—crafted with care,
              love, and timeless elegance.
            </h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 mx-auto gap-8 text-left">
            {[
              ...
              <div
                key={idx}
                className="flex items-start bg-white p-4 rounded-lg shadow-md space-x-4"
              >
